        ...
        <div class="top-bar__container">
            <div class="top-bar__container-wrap">
                <c:forEach var="item" items="${listCategory}">
                    <a href='<c:url value="/all-product-by-category?categoryId=${item.categoryId}"></c:url>'
            ...
            <div class="top-bar__container-wrap">
                <a class="top-bar-phone">
                    ...
                    <span>Tư vấn mua hàng : 0814 941 xxx</span>
                </a>
                <a class="top-bar-phone">
                    <i class="fas fa-headset"></i>
                    <span>CSKH : 0385 122 xxx</span>
                </a>
            </div>
    ...
    <div class="masthead">
        <div class="masthead__container">
            <div class="masthead__logo">
                <a href="<c:url value='/trang-chu'/>" class="masthead__logo-text">UTESHOP</a>
