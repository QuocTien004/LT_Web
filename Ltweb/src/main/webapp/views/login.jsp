            ...
            <div class="col-md-7 col-sm-7">
                <form action="/btltw_04/login" method="post" class="form-horizontal form-without-legend" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="username" name="username"> <!-- Thêm name="username" -->
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="password" class="col-lg-4 control-label">Password <span class="require">*</span></label>
                        <div class="col-lg-8">
                            <input type="password" class="form-control" id="password" name="password"> <!-- Thêm name="password" -->
                        </div>
                    </div>
                    <div class="row">
